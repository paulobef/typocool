  ...
  return (
    ...
    >
      <img
        ...
        height={400}
        width={400}
        css={{ marginBottom: 100, marginTop: 100 }}
      />
      <Text variant="h4">
        It must be up there somewhere, let me take another look...
      </Text>
      <Text variant="lead">
        Sorry {userFirstName}, it looks like we couldn't find the note you were
        looking for.
      </Text>
      <Button
        css={{ marginTop: 20 }}
      ...
      >
        {" "}
        No worries, I'll write a new one
      </Button>
    </div>
  );
}
