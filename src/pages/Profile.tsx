    ...
    return (
        <div css={{ width: 850, paddingLeft: 50, paddingRight: 50, paddingTop: 20, paddingBottom: 20 }}>
            ...
            <form onSubmit={formik.handleSubmit}>
                <InputGroup error={formik.errors.firstName} label={"First Name"} css={{ maxWidth: 150}}>
                    <Input
                        id="firstName"
                        name="firstName"
                        type="name"
                ...
                <InputGroup error={formik.errors.lastName} label={"Last Name"} css={{ maxWidth: 150}}>
                    <Input
                        id="lastName"
                        name="lastName"
                        type="name"
                ...
                <InputGroup error={formik.errors.lastName} label={"Email"} css={{ maxWidth: 200}}>
                    <Input
                        id="email"
                        name="email"
                        type="email"
